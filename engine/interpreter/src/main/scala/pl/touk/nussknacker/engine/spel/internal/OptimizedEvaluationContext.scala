...
class EvaluationContextPreparer(classLoader: ClassLoader,
  ...
  def prepareEvaluationContext(ctx: Context, lazyValuesProvider: LazyValuesProvider, globals: Map[String, Any]): EvaluationContext = {
    val optimized = new OptimizedEvaluationContext(ctx, lazyValuesProvider, expressionFunctions, globals)
...
class OptimizedEvaluationContext(ctx: Context, lazyValuesProvider: LazyValuesProvider, expressionFunctions: Map[String, Method],
                                 globals: Map[String, Any]) extends StandardEvaluationContext {
